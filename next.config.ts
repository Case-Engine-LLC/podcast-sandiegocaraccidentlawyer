...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/privacy', destination: 'https://perrypi.com/privacy-policy/', permanent: true },
      { source: '/privacy-policy', destination: 'https://perrypi.com/privacy-policy/', permanent: true },
    ]
  },
}
