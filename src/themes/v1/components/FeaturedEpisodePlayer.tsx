...
import { episode as defaultEpisode, episodes as defaultEpisodes } from '@/data/siteData'
...
const FeaturedEpisodePlayer = ({
  ...
  const fallbackArt = defaultEpisodes.find((e) => (e as { logo?: string }).logo && (e as { logo?: string }).logo!.trim() !== '')?.logo as string | undefined
